<template>
  <div class="page-home animsition">
    <!-- Slide1 -->
          ...
          <div class="item-slick1 item1-slick1" style="background-image: url(/images/slide1-01.jpg);">
            <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
              ...
              <div class="wrap-btn-slide1 animated visible-false" data-appear="zoomIn">
                <RouterLink to="/menu" class="btn1 flex-c-m size1 txt3 trans-0-4">
                  Look Menu
                </RouterLink>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-6 p-t-45 p-b-30">
            <div class="wrap-text-welcome t-center">
              ...
              <h3 class="tit3 t-center m-b-35 m-t-5">Welcome</h3>
              <p class="t-center m-b-22 size3 m-l-r-auto">
                Donec quis lorem nulla. Nunc eu odio mi. Morbi nec lobortis est. Sed fringilla, nunc sed imperdiet lacinia, nisl ante egestas mi, ac facilisis ligula sem id neque.
              </p>
              <RouterLink to="/about" class="txt4">
                Our Story
    ...
    <section class="section-intro">
      <div class="header-intro parallax100 t-center p-t-135 p-b-158" style="background-image: url(/images/bg-intro-01.jpg);">
        ...
        <h3 class="tit4 t-center p-l-15 p-r-15 p-t-3">FoodSync</h3>
      </div>
          ...
          <div class="row">
            <div class="col-md-4 p-t-30">
              <div class="blo1">
                ...
                <div class="wrap-text-blo1 p-t-35">
                  <a href="#"><h4 class="txt5 color0-hov trans-0-4 m-b-13">Romantic Restaurant</h4></a>
                  <p class="m-b-20">Phasellus lorem enim, luctus ut velit eget, con-vallis egestas eros.</p>
                  <a href="#" class="txt4">Learn More <i class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-4 p-t-30">
              <div class="blo1">
                ...
                <div class="wrap-text-blo1 p-t-35">
                  <a href="#"><h4 class="txt5 color0-hov trans-0-4 m-b-13">Delicious Food</h4></a>
                  <p class="m-b-20">Aliquam eget aliquam magna, quis posuere risus ac justo ipsum nibh urna</p>
                  <a href="#" class="txt4">Learn More <i class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-4 p-t-30">
              <div class="blo1">
                ...
                <div class="wrap-text-blo1 p-t-35">
                  <a href="#"><h4 class="txt5 color0-hov trans-0-4 m-b-13">Red Wines You Love</h4></a>
                  <p class="m-b-20">Sed ornare ligula eget tortor tempor, quis porta tellus dictum.</p>
                  <a href="#" class="txt4">Learn More <i class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                  ...
                  <RouterLink to="/menu" class="btn2 flex-c-m txt5 ab-c-m size4">Lunch</RouterLink>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                  <img src="/images/our-menu-05.jpg" alt="IMG-MENU" />
                  <RouterLink to="/menu" class="btn2 flex-c-m txt5 ab-c-m size5">Dinner</RouterLink>
                </div>
              </div>
              <div class="col-12">
                <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                  <img src="/images/our-menu-13.jpg" alt="IMG-MENU" />
                  <a href="#" class="btn2 flex-c-m txt5 ab-c-m size6">Happy Hour</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                  ...
                  <a href="#" class="btn2 flex-c-m txt5 ab-c-m size7">Drink</a>
                </div>
              </div>
              <div class="col-12">
                <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                  <img src="/images/our-menu-10.jpg" alt="IMG-MENU" />
                  <a href="#" class="btn2 flex-c-m txt5 ab-c-m size8">Starters</a>
                </div>
              </div>
              <div class="col-12">
                <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                  <img src="/images/our-menu-16.jpg" alt="IMG-MENU" />
                  <a href="#" class="btn2 flex-c-m txt5 ab-c-m size9">Dessert</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="wrap-content-slide2 p-t-115 p-b-208">
              <div class="container">
                <div class="title-event t-center m-b-52">
                  <span class="tit2 p-l-15 p-r-15">Upcomming</span>
                ...
                <div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="zoomIn">
                  <a href="#" class="wrap-pic-blo2 bg1-blo2" style="background-image: url(/images/event-02.jpg);">
                    <div class="time-event size10 txt6 effect1">
                      <span class="txt-effect1 flex-c-m t-center">08:00 PM Tuesday - 21 November 2018</span>
                    </div>
                  </a>
                  <div class="wrap-text-blo2 flex-col-c-m p-l-40 p-r-40 p-t-45 p-b-30">
                    <h4 class="tit7 t-center m-b-10">Wines during specific nights</h4>
                    <p class="t-center">Donec quis lorem nulla. Nunc eu odio mi. Morbi nec lobortis est. Sed fringilla, nunc sed imperdiet lacinia</p>
                    <div class="flex-sa-m flex-w w-full m-t-40">
                      <div class="size11 flex-col-c-m">
                        <span class="dis-block t-center txt7 m-b-2 days">25</span>
                      ...
                      <div class="size11 flex-col-c-m">
                        <span class="dis-block t-center txt7 m-b-2 minutes">59</span>
                    ...
                    <a href="#" class="txt4 m-t-40">View Details <i class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="container">
                ...
                <div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="fadeInDown">
                  <a href="#" class="wrap-pic-blo2 bg2-blo2" style="background-image: url(/images/event-06.jpg);">
                    <div class="time-event size10 txt6 effect1">
                      <span class="txt-effect1 flex-c-m">08:00 PM Tuesday - 21 November 2018</span>
                    </div>
                  </a>
                  <div class="wrap-text-blo2 flex-col-c-m p-l-40 p-r-40 p-t-45 p-b-30">
                    <h4 class="tit7 t-center m-b-10">Wines during specific nights</h4>
          ...
          <div class="col-lg-6 p-b-30">
            ...
            <form class="wrap-form-booking">
              ...
              <div class="wrap-btn-booking flex-c-m m-t-6">
                <RouterLink to="/reservation" class="btn3 flex-c-m size13 txt11 trans-0-4">Book Table</RouterLink>
              </div>
            </form>
          </div>
            ...
            <div class="wrap-content-slide3 p-b-50 p-t-50">
              <div class="container">
                ...
                <div class="content-review m-t-33 animated visible-false" data-appear="fadeInUp">
                  ...
                  <div class="more-review txt4 t-center animated visible-false m-t-32" data-appear="fadeInUp">Marie Simmons ˗ New York</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 p-t-30">
            <div class="blo1">
              <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
                <RouterLink to="/blog"><img src="/images/blog-01.jpg" alt="IMG-INTRO" /></RouterLink>
                <div class="time-blog">21 Dec 2017</div>
              </div>
              <div class="wrap-text-blo1 p-t-35">
                <RouterLink to="/blog"><h4 class="txt5 color0-hov trans-0-4 m-b-13">Best Places for Wine</h4></RouterLink>
                <p class="m-b-20">Phasellus lorem enim, luctus ut velit eget, con-vallis egestas eros.</p>
                <RouterLink to="/blog" class="txt4">Continue Reading <i class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i></RouterLink>
              </div>
            </div>
          </div>
          <div class="col-md-4 p-t-30">
            <div class="blo1">
              <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
                <RouterLink to="/blog"><img src="/images/blog-02.jpg" alt="IMG-INTRO" /></RouterLink>
                <div class="time-blog">15 Dec 2017</div>
              </div>
              <div class="wrap-text-blo1 p-t-35">
                <RouterLink to="/blog"><h4 class="txt5 color0-hov trans-0-4 m-b-13">Eggs and Cheese</h4></RouterLink>
                <p class="m-b-20">Duis elementum, risus sit amet lobortis nunc justo condimentum ligula, vitae feugiat</p>
                <RouterLink to="/blog" class="txt4">Continue Reading <i class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i></RouterLink>
              </div>
            </div>
          </div>
          <div class="col-md-4 p-t-30">
            <div class="blo1">
              <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
                <RouterLink to="/blog"><img src="/images/blog-03.jpg" alt="IMG-INTRO" /></RouterLink>
                <div class="time-blog">12 Dec 2017</div>
              </div>
              <div class="wrap-text-blo1 p-t-35">
                <RouterLink to="/blog"><h4 class="txt5 color0-hov trans-0-4 m-b-13">Style the Wedding Party</h4></RouterLink>
                <p class="m-b-20">Sed ornare ligula eget tortor tempor, quis porta tellus dictum.</p>
                <RouterLink to="/blog" class="txt4">Continue Reading <i class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i></RouterLink>
              </div>
            </div>
