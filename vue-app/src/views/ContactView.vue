<template>
  <div class="page-contact animsition">
    <!-- Title Page -->
      ...
      <div class="container">
        ...
        <form class="wrap-form-reservation size22 m-l-r-auto">
          ...
          <div class="wrap-btn-booking flex-c-m m-t-13">
            <button type="submit" class="btn3 flex-c-m size36 txt11 trans-0-4">Submit</button>
          </div>
        </form>
          ...
          <div class="col-sm-8 col-md-4 col-lg-4 m-l-r-auto p-t-30">
            <div class="dis-flex m-l-23">
              ...
              <div class="flex-col-l">
                ...
                <span class="txt23 size38">8th floor, 379 Hudson St, New York, NY 10018</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-8 col-md-5 col-lg-4 m-l-r-auto p-t-30">
            <div class="dis-flex m-l-23">
              ...
              <div class="flex-col-l">
                ...
                <span class="txt23 size38">09:30 AM – 11:00 PM <br />Every Day</span>
              </div>
            </div>
          </div>
        </div>
