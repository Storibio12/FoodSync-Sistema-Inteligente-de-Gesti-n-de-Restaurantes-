  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Gestión de Mesas</h1>
          <p className="text-sm text-slate-500 mt-1">Administra la distribución y capacidad de las mesas del restaurante.</p>
        </div>
        <button
          onClick={() => { setModal({}); setForm({ table_number: "", capacity: "" }); }}
            ...
            >
              <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
                <h3 className="text-lg font-semibold text-slate-900">
                  {modal.id != null ? "Editar mesa" : "Registrar nueva mesa"}
                </h3>
                <button
                  onClick={() => setModal(null)}
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="pt-4 flex items-center justify-end gap-3 border-t border-slate-100 mt-6">
                  ...
                  >
                    {modal.id != null ? "Guardar cambios" : "Crear mesa"}
                  </button>
                </div>
              </form>
            </motion.div>
